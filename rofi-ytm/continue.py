...
process = Popen(['rofi', '-theme', '~/rofi-collection/material/material.rasi' ,'-dmenu', '-p', 'play next', '-l', '3'], stdout=PIPE, stdin=PIPE)
...
if not autoplay:
    ...
    process = Popen(['rofi', '-theme', '~/rofi-collection/material/material.rasi', '-dmenu', '-p', 'pick video', '-l', str(config.RESULT_COUNT)], stdout=PIPE, stdin=PIPE)
